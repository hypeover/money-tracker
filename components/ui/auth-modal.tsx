        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-0">
            ...
            <motion.div
              ...
              animate="show"
              exit="exit"
              className="relative w-full max-w-90 overflow-hidden rounded-3xl bg-white p-6 shadow-2xl dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900 ring-1 ring-zinc-950/5"
            >
