          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
            ...
            >
              ...
              >
                ...
                <motion.div
                  variants={item}
                  className="flex flex-row justify-center gap-5 mb-8"
                >
                  {socialButtons.map((btn, i) => (
                    <button
                      key={i}
                      className={cn(
                        "flex aspect-square items-center justify-center p-4 rounded-2xl border border-zinc-200 bg-white transition-all hover:scale-105 active:scale-95 dark:border-zinc-800 dark:bg-zinc-950",
                        btn.color,
                      )}
